          ...
          [:div.illustration.illustration-1.group
            ...
            [:div.description.group
              [:div.title
                "Simplicity"]
              [:div.subtitle
                "Whether you’re adding a quick team update about one topic, or "
                "writing a regular stakeholder update that covers many, getting "
                "started is fast and simple."]]]
          ...
          [:div.illustration.illustration-2.group
            ...
            [:div.description.group
              [:div.title
                "Company timeline"]
              [:div.subtitle
                "It’s easy to catch up if you missed something or want more context. "
                "Great for getting new employees up to speed, too."]]]
          ...
          [:div.illustration.illustration-3.group
            ...
            [:div.description.group
              [:div.title
                "Feedback loops"]
              [:div.subtitle
                "Company updates are best when they trigger conversation. Comments and "
                "reactions keep everyone engaged and in sync - great for distributed teams."]]]
          ...
          [:div.illustration.illustration-4.group
            ...
            [:div.description.group
              [:div.title
                "Works with Slack"]
              [:div.subtitle
                "With Slack single sign-on and our Slack bot, updates are automatically shared "
                "to the right channels. Discussions about updates can happen within Slack or "
          ...
          [:div.illustration.illustration-5.group
            ...
            [:div.description.group
              [:div.title
                "Go public"]
              [:div.subtitle
                "Updates can also be made public - ideal for crowdfunded ventures, social enterprises, "
