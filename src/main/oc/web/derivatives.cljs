...
(defn drv-spec [db]
  {:base                [[] db]
   ...
   :container-slug      [[:board-slug :contributions-id :label-slug :activity-uuid]
                         (fn [board-slug contributions-id label-slug activity-uuid]
                           (when activity-uuid
                             (or board-slug
                                 contributions-id
                                 label-slug)))]
                         ...
                         (fn [base org-slug board-slug entry-board-slug contributions-id label-slug sort-type]
                           (when (and org-slug
                             ...
                             (let [is-contributions? (seq contributions-id)
                                   ...
                                   container-key (cond is-contributions?
                                                       (dis/contributions-data-key org-slug contributions-id)
                                                       is-label?
                                                       (dis/label-entries-data-key org-slug label-slug)
   ...
   :show-login-wall?      [[:jwt :force-login-wall :activity-uuid :org-not-found? :board-not-found? :contributions-not-found? :label-not-found? :entry-not-found?]
                           (fn [jwt-data force-login-wall current-activity-id org-not-found? board-not-found? contributions-not-found? label-not-found? entry-not-found?]
                             (boolean
                              (and (not jwt-data)
                                   (or force-login-wall
   ...
   :show-push-notification-permissions-modal? [[:jwt :user-responded-to-push-permission?]
                                               (fn [jwt-data user-responded-to-push-permission?]
                                                 (boolean
                                                  (and jwt-data
                                                       (not user-responded-to-push-permission?))))]
   :show-labels-manager?   [[:base] (fn [base] (:show-labels-manager base))]
   ...
   :foc-menu              [[:base] (fn [base] (get base dis/foc-menu-key))]
