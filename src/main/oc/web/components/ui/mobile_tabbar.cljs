...
(rum/defc mobile-tabbar
  [{:keys [can-compose? is-following is-topics is-replies mobile-user-notifications
           show-add-post-tooltip user-notifications-data]}]
  (let [no-phisical-home-button (^js js/isiPhoneWithoutPhysicalHomeBt)]
    [:div.mobile-tabbar
