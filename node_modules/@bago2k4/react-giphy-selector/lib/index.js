...
var Images = __webpack_require__(20);
...
const GiphyClient_1 = __webpack_require__(13);
const QueryForm_1 = __webpack_require__(28);
const Suggestions_1 = __webpack_require__(29);
const SearchResults_1 = __webpack_require__(31);
...
class Selector extends React.Component {
    ...
    render() {
        ...
        const { suggestions, onGifSelected, queryInputPlaceholder, resultColumns, showGiphyMark, preloadTrending, containerClassName, queryFormAutoFocus, queryFormClassName, queryFormInputClassName, queryFormSubmitClassName, queryFormSubmitContent, searchResultClassName, searchResultsClassName, suggestionClassName, suggestionsClassName, loaderClassName, loaderContent, searchErrorClassName, footerClassName } = this.props;
        ...
        return (React.createElement("div", { className: containerClassName },
            React.createElement(QueryForm_1.QueryForm, { queryInputPlaceholder: queryInputPlaceholder, onQueryChange: this.onQueryChange, onQueryExecute: this.onQueryExecute, queryValue: query, queryFormAutoFocus: queryFormAutoFocus, queryFormClassName: queryFormClassName, queryFormInputClassName: queryFormInputClassName, queryFormSubmitClassName: queryFormSubmitClassName, queryFormSubmitContent: queryFormSubmitContent }),
            showSuggestions && (React.createElement(Suggestions_1.Suggestions, { suggestions: suggestions, onSuggestionSelected: this.onSuggestionSelected, suggestionClassName: suggestionClassName, suggestionsClassName: suggestionsClassName })),
            isPending && (React.createElement("div", { className: loaderClassName }, loaderContent)),
            !isPending &&
                !!searchError && (React.createElement("div", { className: searchErrorClassName }, searchError.message)),
            !isPending &&
                !!searchResult && (React.createElement(SearchResults_1.SearchResults, { searchResultClassName: searchResultClassName, searchResultsClassName: searchResultsClassName, columns: resultColumns, gifObjects: searchResult.gifObjects, onGifSelected: onGifSelected })),
            React.createElement("footer", { className: footerClassName },
                React.createElement("img", { src: footerImgSrc }))));
    }
}
...
const GiphyJSClient = __webpack_require__(14);
class GiphyClient {
    constructor(apiKey) {
...
var RequestHandler = __webpack_require__(17);
...
var responseFormatter = __webpack_require__(19);
...
var _ = __webpack_require__(2);
var Media = __webpack_require__(6);
var Category = __webpack_require__(23);
var TermSuggestion = __webpack_require__(24);
...
var Image = __webpack_require__(21);
...
class QueryForm extends React.Component {
    ...
    render() {
        const { queryValue, queryInputPlaceholder, queryFormAutoFocus, queryFormClassName, queryFormInputClassName, queryFormSubmitClassName, queryFormSubmitContent } = this.props;
        return (React.createElement("div", null,
            React.createElement("form", { className: queryFormClassName, onSubmit: this.onSubmit },
                React.createElement("input", { className: queryFormInputClassName, value: queryValue, type: "text", onChange: this.onValueChange, placeholder: queryInputPlaceholder, ref: this.setSearchInputRef }),
                React.createElement("button", { type: "submit", className: queryFormSubmitClassName }, queryFormSubmitContent))));
    }
}
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(0);
const Suggestion_1 = __webpack_require__(30);
class Suggestions extends React.Component {
    constructor(props) {
        super(props);
    }
    render() {
        const { suggestions, onSuggestionSelected, suggestionClassName, suggestionsClassName } = this.props;
        return (React.createElement("div", { className: suggestionsClassName }, suggestions.map((s) => (React.createElement(Suggestion_1.Suggestion, { key: `suggestion-${s}`, suggestion: s, onSelected: onSuggestionSelected, suggestionClassName: suggestionClassName })))));
    }
}
...
class Suggestion extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("a", { className: suggestionClassName, 
...
Object.defineProperty(exports, "__esModule", { value: true });
const React = __webpack_require__(0);
const SearchResult_1 = __webpack_require__(32);
class SearchResults extends React.Component {
    ...
    render() {
        const { gifObjects, onGifSelected, searchResultsClassName, searchResultClassName } = this.props;
        const columnGifs = this.getColumnGifs(gifObjects);
        return (React.createElement("ul", { className: searchResultsClassName }, columnGifs.map((column, c) => (React.createElement("li", { key: `column-${c}` },
            React.createElement("ul", null, column.map((gifObject) => (React.createElement(SearchResult_1.SearchResult, { searchResultClassName: searchResultClassName, key: gifObject.id, gifObject: gifObject, onSelected: onGifSelected })))))))));
    }
}
    ...
    render() {
        ...
        return (React.createElement("li", null,
            React.createElement("a", { 
                // href="javascript:void(0)"
                onClick: this.onClick, className: searchResultClassName },
