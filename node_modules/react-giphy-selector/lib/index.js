...
var Selector = /** @class */ (function (_super) {
    ...
    function Selector(props) {
        ...
        _this.client = new GiphyClient_1.GiphyClient(props.apiKey);
        // Set initial state
        _this.state = {
            query: "",
            isPending: false,
        ...
        _this.onQueryExecute = _this.onQueryExecute.bind(_this);
     ...
     */
    Selector.prototype.onQueryExecute = function () {
        var _this = this;
        var query = this.state.query;
        var _a = this.props, rating = _a.rating, sort = _a.sort, limit = _a.limit;
        this.setState({
            isPending: true,
            searchError: null
        });
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js?sourceMap&modules!./QueryForm.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js?sourceMap&modules!./QueryForm.css");
...
var Suggestions = /** @class */ (function (_super) {
    ...
    Suggestions.prototype.render = function () {
        var _a = this.props, suggestions = _a.suggestions, onSuggestionSelected = _a.onSuggestionSelected, suggestionClassName = _a.suggestionClassName, suggestionStyle = _a.suggestionStyle, suggestionsClassName = _a.suggestionsClassName, suggestionsStyle = _a.suggestionsStyle;
        return (React.createElement("div", { style: suggestionsStyle, className: cn(defaultStyle.suggestions, suggestionsClassName) }, suggestions.map(function (s) { return (React.createElement(Suggestion_1.Suggestion, { key: "suggestion-" + s, suggestion: s, onSelected: onSuggestionSelected, suggestionClassName: suggestionClassName, suggestionStyle: suggestionStyle })); })));
    };
    return Suggestions;
}(React.Component));
...
var Suggestion = /** @class */ (function (_super) {
    ...
    Suggestion.prototype.render = function () {
        var _a = this.props, suggestion = _a.suggestion, suggestionClassName = _a.suggestionClassName, suggestionStyle = _a.suggestionStyle;
        return (React.createElement("a", { style: suggestionStyle, className: cn(defaultStyle.suggestion, suggestionClassName), href: "javascript:void(0)", onClick: this.onClick }, suggestion));
    };
    return Suggestion;
}(React.Component));
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js?sourceMap&modules!./SearchResult.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js?sourceMap&modules!./SearchResult.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// exports
exports.locals = {
	"searchResult": "_1xucwUbJoGuYN5CpszaTNr"
};
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js?sourceMap&modules!./SearchResults.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js?sourceMap&modules!./SearchResults.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, "._1pFCYnVJ_z52InVhXxobG8 {\n\tmargin: 0;\n\tpadding: 0;\n\tlist-style: none;\n\tdisplay: flex;\n\t\n\tmax-height: 300px;\n\toverflow-y: auto;\n}\n\n._1pFCYnVJ_z52InVhXxobG8 > li {\n\tpadding: 0;\n\tmargin: 0;\n\tdisplay: block;\n\tmin-width: 50px;\n\tflex-grow: 1;\n}\n\n._1pFCYnVJ_z52InVhXxobG8 > li > ul {\n\tlist-style: none;\n\tmargin: 0;\n\tpadding: 0 5px;\n}\n\n._1pFCYnVJ_z52InVhXxobG8 > li > ul > li {\n\tmargin-bottom: 5px;\n}", "", {"version":3,"sources":["/home/ec2-user/environment/react-giphy-selector/src/components/SearchResults.css"],"names":[],"mappings":"AAAA;CACC,UAAU;CACV,WAAW;CACX,iBAAiB;CACjB,cAAc;;CAEd,kBAAkB;CAClB,iBAAiB;CACjB;;AAED;CACC,WAAW;CACX,UAAU;CACV,eAAe;CACf,gBAAgB;CAChB,aAAa;CACb;;AAED;CACC,iBAAiB;CACjB,UAAU;CACV,eAAe;CACf;;AAED;CACC,mBAAmB;CACnB","file":"SearchResults.css","sourcesContent":[".searchResults {\n\tmargin: 0;\n\tpadding: 0;\n\tlist-style: none;\n\tdisplay: flex;\n\t\n\tmax-height: 300px;\n\toverflow-y: auto;\n}\n\n.searchResults > li {\n\tpadding: 0;\n\tmargin: 0;\n\tdisplay: block;\n\tmin-width: 50px;\n\tflex-grow: 1;\n}\n\n.searchResults > li > ul {\n\tlist-style: none;\n\tmargin: 0;\n\tpadding: 0 5px;\n}\n\n.searchResults > li > ul > li {\n\tmargin-bottom: 5px;\n}"],"sourceRoot":""}]);

// exports
exports.locals = {
	"searchResults": "_1pFCYnVJ_z52InVhXxobG8"
};
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js?sourceMap&modules!./Selector.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js?sourceMap&modules!./Selector.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
