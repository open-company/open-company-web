...
require("module$node_modules$$sentry$hub$dist$index");exports.captureException=function(exception,captureContext){try{throw Error("Sentry syntheticException");}catch(exception$2){var syntheticException=exception$2}return callOnHub("captureException",exception,{captureContext:captureContext,originalException:exception,syntheticException:syntheticException})};exports.captureMessage=function(message,captureContext){try{throw Error(message);}catch(exception){var syntheticException=exception}return callOnHub("captureMessage",
message,"string"===typeof captureContext?captureContext:void 0,tslib_1.__assign({originalException:message,syntheticException:syntheticException},"string"!==typeof captureContext?{captureContext:captureContext}:void 0))};exports.captureEvent=function(event){return callOnHub("captureEvent",event)};exports.configureScope=function(callback){callOnHub("configureScope",callback)};exports.addBreadcrumb=function(breadcrumb){callOnHub("addBreadcrumb",breadcrumb)};exports.setContext=function(name,context){callOnHub("setContext",
name,context)};exports.setExtras=function(extras){callOnHub("setExtras",extras)};exports.setTags=function(tags){callOnHub("setTags",tags)};exports.setExtra=function(key,extra){callOnHub("setExtra",key,extra)};exports.setTag=function(key,value){callOnHub("setTag",key,value)};exports.setUser=function(user){callOnHub("setUser",user)};exports.withScope=function(callback){callOnHub("withScope",callback)};exports._callOnClient=function(method){for(var args=[],_i=1;_i<arguments.length;_i++)args[_i-1]=arguments[_i];
callOnHub.apply(void 0,tslib_1.__spread(["_invokeClient",method],args))};exports.startTransaction=function(context){return callOnHub("startTransaction",tslib_1.__assign({},context))}}
