...
var G__43169 = cljs.core.first(element_str);
switch (G__43169) {
case "?":
arr.push((1));
...
var G__43215 = cljs.core.next(items);
items = G__43215;
continue;
} else {
return null;
...
var G__43218 = cljs.core.next(items);
items = G__43218;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__43186 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__43186) : is_valid_QMARK_.call(null,G__43186));
})())){
var G__43227 = cljs.core.next(cljs.core.next(items));
items = G__43227;
continue;
} else {
return true;
...
switch (G__43191) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__43189_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__43189_SHARP_,(2));
})))){
...
break;
case (1):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__43190_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__43190_SHARP_,(1));
})))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__43191)].join('')));
