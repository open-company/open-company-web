...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28174 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_28174(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28175 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_28175(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28178 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_28178(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28180 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_28180(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$commit$dyn_28186 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_28186(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28189 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_28189(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28191 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_28191(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28195 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_28195(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28196 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_28196(b);
}
});
