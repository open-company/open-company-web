...
var periods__$1 = cljs.core.vec((function (){var G__46115 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46114_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__46114_SHARP_,(0),(3));
}),G__46115);
} else {
return G__46115;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__46147){
var vec__46149 = p__46147;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46149,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46149,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__46153 = pattern;
switch (G__46153) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46153)].join('')));
...
return p1__46156_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__46157_SHARP_){
return p1__46157_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__46158_SHARP_){
return p1__46158_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__46159_SHARP_){
return p1__46159_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__46160_SHARP_){
return p1__46160_SHARP_.getHours();
});

break;
case "day":
return (function (p1__46161_SHARP_){
return p1__46161_SHARP_.getDate();
});

break;
case "month":
return (function (p1__46162_SHARP_){
return p1__46162_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__46163_SHARP_){
return p1__46163_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46171__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__46176){
var vec__46177 = p__46176;
var seq__46178 = cljs.core.seq(vec__46177);
var first__46179 = cljs.core.first(seq__46178);
var seq__46178__$1 = cljs.core.next(seq__46178);
var key = first__46179;
var args = seq__46178__$1;
var G__46182 = key;
...
break;
case "ordinal-suffix":
var vec__46185 = (function (){var G__46188 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__46188) : syntax_list.call(null,G__46188));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46185,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46182__$1)].join('')));
...
var d = value;
var G__46195 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__46196 = G__46195;
...
var unparser = first__46198;
var more = seq__46197__$1;
var s = "";
var d__$1 = d;
var G__46195__$1 = G__46195;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__46212 = G__46195__$1;
var seq__46213 = cljs.core.seq(vec__46212);
var first__46214 = cljs.core.first(seq__46213);
var seq__46213__$1 = cljs.core.next(seq__46213);
var unparser__$1 = first__46214;
var more__$1 = seq__46213__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__46215 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46215,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46215,(1),null);
var G__46287 = d__$3;
var G__46288 = more__$1;
var G__46289 = s__$3;
d__$1 = G__46287;
G__46195__$1 = G__46288;
s__$1 = G__46289;
continue;
}
break;
