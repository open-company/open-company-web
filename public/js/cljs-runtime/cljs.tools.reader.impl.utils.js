...
(cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k27119,else__4383__auto__){
var self__ = this;
...
(cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__27118){
var self__ = this;
...
(cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this27120,other27121){
var self__ = this;
var this27120__$1 = this;
return (((!((other27121 == null)))) && ((this27120__$1.constructor === other27121.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27120__$1.splicing_QMARK_,other27121.splicing_QMARK_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27120__$1.form,other27121.form)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this27120__$1.__extmap,other27121.__extmap)));
}));
...
(cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__27118){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__27143 = cljs.core.keyword_identical_QMARK_;
var expr__27144 = k__4388__auto__;
if(cljs.core.truth_((pred__27143.cljs$core$IFn$_invoke$arity$2 ? pred__27143.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),expr__27144) : pred__27143.call(null,new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),expr__27144)))){
return (new cljs.tools.reader.impl.utils.ReaderConditional(G__27118,self__.form,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__27143.cljs$core$IFn$_invoke$arity$2 ? pred__27143.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"form","form",-1624062471),expr__27144) : pred__27143.call(null,new cljs.core.Keyword(null,"form","form",-1624062471),expr__27144)))){
return (new cljs.tools.reader.impl.utils.ReaderConditional(self__.splicing_QMARK_,G__27118,self__.__meta,self__.__extmap,null));
} else {
return (new cljs.tools.reader.impl.utils.ReaderConditional(self__.splicing_QMARK_,self__.form,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__27118),null));
}
}
}));
...
(cljs.tools.reader.impl.utils.ReaderConditional.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__27118){
var self__ = this;
var this__4379__auto____$1 = this;
return (new cljs.tools.reader.impl.utils.ReaderConditional(self__.splicing_QMARK_,self__.form,G__27118,self__.__extmap,self__.__hash));
}));
 ...
 */
cljs.tools.reader.impl.utils.map__GT_ReaderConditional = (function cljs$tools$reader$impl$utils$map__GT_ReaderConditional(G__27122){
var extmap__4419__auto__ = (function (){var G__27146 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__27122,new cljs.core.Keyword(null,"splicing?","splicing?",-428596366),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"form","form",-1624062471)], 0));
if(cljs.core.record_QMARK_(G__27122)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__27146);
} else {
return G__27146;
}
})();
return (new cljs.tools.reader.impl.utils.ReaderConditional(new cljs.core.Keyword(null,"splicing?","splicing?",-428596366).cljs$core$IFn$_invoke$arity$1(G__27122),new cljs.core.Keyword(null,"form","form",-1624062471).cljs$core$IFn$_invoke$arity$1(G__27122),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var iter__4529__auto__ = (function cljs$tools$reader$impl$utils$namespace_keys_$_iter__27152(s__27153){
return (new cljs.core.LazySeq(null,(function (){
var s__27153__$1 = s__27153;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__27153__$1);
if(temp__5735__auto__){
var s__27153__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__27153__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__27153__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__27155 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__27154 = (0);
while(true){
if((i__27154 < size__4528__auto__)){
var key = cljs.core._nth(c__4527__auto__,i__27154);
cljs.core.chunk_append(b__27155,(((((key instanceof cljs.core.Symbol)) || ((key instanceof cljs.core.Keyword))))?(function (){var vec__27156 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace,cljs.core.name)(key);
var key_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27156,(0),null);
var key_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27156,(1),null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27155),cljs$tools$reader$impl$utils$namespace_keys_$_iter__27152(cljs.core.chunk_rest(s__27153__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27155),null);
}
} else {
var key = cljs.core.first(s__27153__$2);
return cljs.core.cons((((((key instanceof cljs.core.Symbol)) || ((key instanceof cljs.core.Keyword))))?(function (){var vec__27159 = cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace,cljs.core.name)(key);
var key_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27159,(0),null);
var key_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27159,(1),null);
var __GT_key = (((key instanceof cljs.core.Symbol))?cljs.core.symbol:cljs.core.keyword);
if((key_ns == null)){
return (__GT_key.cljs$core$IFn$_invoke$arity$2 ? __GT_key.cljs$core$IFn$_invoke$arity$2(ns,key_name) : __GT_key.call(null,ns,key_name));
} else {
...
})():key),cljs$tools$reader$impl$utils$namespace_keys_$_iter__27152(cljs.core.rest(s__27153__$2)));
}
} else {
return null;
}
...
cljs.tools.reader.impl.utils.second_SINGLEQUOTE_ = (function cljs$tools$reader$impl$utils$second_SINGLEQUOTE_(p__27162){
var vec__27163 = p__27162;
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27163,(0),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27163,(1),null);
