...
var G__42932 = cljs.core.next(items);
items = G__42932;
continue;
} else {
return arr;
...
var x42884 = error;
(x42884.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL);

(x42884.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (_obj,writer,opts){
var _obj__$1 = this;
...
var G__42934 = Object.getPrototypeOf(o);
o = G__42934;
continue;
} else {
