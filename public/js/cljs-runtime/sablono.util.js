...
var sablono$util$ToString$to_str$dyn_34711 = (function (x){
...
return sablono$util$ToString$to_str$dyn_34711(x);
}
});
...
var sablono$util$ToURI$to_uri$dyn_34712 = (function (x){
var x__4428__auto__ = (((x == null))?null:x);
...
return sablono$util$ToURI$to_uri$dyn_34712(x);
}
});
...
/** @this {Function} */
(sablono.util.as_str.cljs$lang$applyTo = (function (seq34702){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq34702));
}));
...
var vec__34703 = cljs.core.name(k).split("-");
...
var first_word = first__34705;
var words = seq__34704__$1;
...
var m__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__34706){
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__34710,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__34710;
}
} else {
