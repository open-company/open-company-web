...
_options&&(_options={});this._options=_options;this.name=InboundFilters.id}InboundFilters.prototype.setupOnce=function(){hub_1.addGlobalEventProcessor(function(event){var hub=hub_1.getCurrentHub();if(!hub)return event;var self=hub.getIntegration(InboundFilters);return self&&(hub=(hub=hub.getClient())?hub.getOptions():{},hub=self._mergeOptions(hub),self._shouldDropEvent(event,hub))?null:event})};InboundFilters.prototype._shouldDropEvent=function(event,options){return this._isSentryError(event,options)?
(utils_1.logger.warn("Event dropped due to being internal Sentry Error.\nEvent: "+utils_1.getEventDescription(event)),!0):this._isIgnoredError(event,options)?(utils_1.logger.warn("Event dropped due to being matched by `ignoreErrors` option.\nEvent: "+utils_1.getEventDescription(event)),!0):this._isDeniedUrl(event,options)?(utils_1.logger.warn("Event dropped due to being matched by `denyUrls` option.\nEvent: "+utils_1.getEventDescription(event)+".\nUrl: "+this._getEventFilterUrl(event)),!0):this._isAllowedUrl(event,
options)?!1:(utils_1.logger.warn("Event dropped due to not being matched by `allowUrls` option.\nEvent: "+utils_1.getEventDescription(event)+".\nUrl: "+this._getEventFilterUrl(event)),!0)};InboundFilters.prototype._isSentryError=function(event,options){if(!options.ignoreInternal)return!1;try{return event&&event.exception&&event.exception.values&&event.exception.values[0]&&"SentryError"===event.exception.values[0].type||!1}catch(_oO){return!1}};InboundFilters.prototype._isIgnoredError=function(event,
options){return options.ignoreErrors&&options.ignoreErrors.length?this._getPossibleEventMessages(event).some(function(message){return options.ignoreErrors.some(function(pattern){return utils_1.isMatchingPattern(message,pattern)})}):!1};InboundFilters.prototype._isDeniedUrl=function(event,options){if(!options.denyUrls||!options.denyUrls.length)return!1;var url=this._getEventFilterUrl(event);return url?options.denyUrls.some(function(pattern){return utils_1.isMatchingPattern(url,pattern)}):!1};InboundFilters.prototype._isAllowedUrl=
function(event,options){if(!options.allowUrls||!options.allowUrls.length)return!0;var url=this._getEventFilterUrl(event);return url?options.allowUrls.some(function(pattern){return utils_1.isMatchingPattern(url,pattern)}):!0};InboundFilters.prototype._mergeOptions=function(clientOptions){void 0===clientOptions&&(clientOptions={});return{allowUrls:tslib_1.__spread(this._options.whitelistUrls||[],this._options.allowUrls||[],clientOptions.whitelistUrls||[],clientOptions.allowUrls||[]),denyUrls:tslib_1.__spread(this._options.blacklistUrls||
